...
def get_pairs(data,W,params):
    ...
    ''' get pairs according to label_pred by get_label_pred
    ...
    if W is not None:
        ...
        lab_pred = get_label_pred(W,params)
...
def get_label_pred(W,params):
    ...
    s = spectral.fit(W)
    # np.save('get_label_pred_matrix.npy',s.affinity_matrix_)
